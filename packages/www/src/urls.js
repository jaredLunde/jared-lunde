...
export const twitter = () => 'https://twitter.com/jaredLunde'
export const instagram = () => 'https://instagram.com/jaredlunde'
export const gitHub = () => 'https://github.com/jaredLunde'
export const gitHubRepo = repo => `https://github.com/jaredLunde/${repo}`