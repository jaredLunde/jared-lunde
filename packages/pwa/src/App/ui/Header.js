...
class Header extends React.PureComponent {
  render () {
    return (
      <NavBar bc='darkerGrey' bg='white' pos='sticky' bw='4' br='2' h='60' id='main-header' data-strict>
          ...
          <TransitionDrop fromLeft med delay={300} easing='heavyMove'>
            {({className}) => (
              <Row align='center' w={64} h={60} p='x3' className={className} data-strict>
                <Icon name='logo' color='darkerGrey' size='32' />
              </Row>
            )}
          </TransitionDrop>
          <TransitionDrop fromRight med delay={300} easing='heavyMove'>
            {({className}) => <H1 xxs right m='r3' color='darkerGrey' pos='relative' style={{top: 2, lineHeight: 1}} className={className}>JARED<br/>LUNDE</H1>}
          </TransitionDrop>
        </Row>
      </NavBar>
    )
